...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  ...
  instance.centralManager = [[CBCentralManager alloc] initWithDelegate:instance queue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_BACKGROUND, 0) options: @{CBCentralManagerOptionRestoreIdentifierKey: @"com.gastonmuijtjens.test"}];
